...
class Hologram(object):
    ...
    def fourier_peak_centroid(self, fourier_arr, mask_radius=None,
                              margin_factor=0.1, plot=False,search_area = None):
        """
...
if __name__ == "__main__":
    ...
    hologram_path = '/Users/zhangyunping/PycharmProjects/offaxisDH/Data/checkbg/bg_both3.bmp'
    ...
    h = Hologram.from_file(hologram_path,crop_size=1024,bg=None)
    h.reconstruct(plot_fourier_peak=True)
    ...
    h = Hologram.from_file(hologram_path,crop_size=1024,bg=None)
    h.reconstruct(plot_fourier_peak=True)
    hologram_path = '/Users/zhangyunping/PycharmProjects/offaxisDH/Data/checkbg/bg_both10.bmp'
